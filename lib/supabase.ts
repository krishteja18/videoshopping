...
export const supabaseAdmin = createClient(
  supabaseUrl,
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl1d3Fydm55Z3BubWt4dnVjb2lnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NTcwOTYyMSwiZXhwIjoyMDcxMjg1NjIxfQ.VGgax4fHFsgI_5Y7rzWXI-dLSDXz_qXkwqSuC1XIY-M', // Replace with service role key
  {
    auth: {
